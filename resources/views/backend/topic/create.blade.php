    ...
    <div class="br-pagetitle">
        ...
        <div>
            ...
            <p class="mg-b-0">
                ...
                / <a href="{{ url('admin/topic/index') }}">Manage Topic</a> / Add Topic /
            </p>
        </div>
    </div>
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            <div class="row">
                ...
                <div class="col-md-12">
                    <form action="{{ $page == 'edit' ? url('admin/topic/update/'.$topic->id) : url('admin/topic/store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="">Name</label>
                            <input type="text" name="name" value="{{ $topic->name ?? old('name') }}" class="form-control" placeholder="Topic name" required>
                            @if ($errors->has('name'))
