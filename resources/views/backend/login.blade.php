    ...
    <div class="row no-gutters flex-row-reverse ht-100v">
      ...
      <div class="col-md-6 bg-br-primary d-flex align-items-center justify-content-center">
        <div class="wd-250 wd-xl-450 mg-y-30">
          <div class="signin-logo tx-28 tx-bold tx-white"><span class="tx-normal">[</span> Bill Patente <span class="tx-info">Italy</span> <span class="tx-normal">]</span></div>
          <div class="tx-white mg-b-60 text-capitalize">Best Driving School organisation from Italy</div>
          <div class="tx-white mg-b-60">The Admin Panel For Bill Patente</div>
