...
<div class="row row-sm">
  ...
  <div class="col-sm-6 col-xl-3 mg-t-20 mg-sm-t-0">
    <div class="bg-purple rounded overflow-hidden" style="cursor: pointer;" onclick="location.href='{{ url('admin/lesson/index') }}'">
      <div class="pd-x-20 pd-t-20 d-flex align-items-center">
        <i class="ion ion-social-youtube-outline  tx-60 lh-0 tx-white op-7"></i>
        <div class="mg-l-20">
          <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Lessons</p>
          <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">
  ...
  <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
    <div class="bg-teal rounded overflow-hidden" style="cursor: pointer;" onclick="location.href='{{ url('admin/subscription/index') }}'">
      <div class="pd-x-20 pd-t-20 d-flex align-items-center">
        <i class="ion ion-android-done-all  tx-60 lh-0 tx-white op-7"></i>
        <div class="mg-l-20">
          <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Subscribed</p>
          <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">
             {{ App\Models\User::where('subscription_id', '!=', null)->count() }}
          </p>
        </div>
      </div>
  ...
  <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
    <div class="bg-primary rounded overflow-hidden" style="cursor: pointer;" onclick="location.href='{{ url('admin/topic/index') }}'">
      <div class="pd-x-20 pd-t-20 d-flex align-items-center">
        <i class="ion ion-android-list tx-60 lh-0 tx-white op-7"></i>
        <div class="mg-l-20">
          <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Topics</p>
          <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">
